// DecreaseAdditionalValidatorStakeWithVote
...
#[derive(Accounts)]
pub struct DecreaseAdditionalValidatorStakeWithVote<'info> {
...
impl<'info> DecreaseAdditionalValidatorStakeWithVote<'info> {
    ...
    pub fn context_handler(
        ...
        let ix = decrease_additional_validator_stake_with_vote(
