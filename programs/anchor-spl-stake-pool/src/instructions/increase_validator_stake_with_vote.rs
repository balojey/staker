// IncreaseValidatorStakeWithVote
// (Staker only) Increase stake on a validator from the reserve account

// Internally, this instruction splits reserve stake into a transient stake account
// and delegate to the appropriate validator. UpdateValidatorListBalance will do the work
// of merging once it’s ready.

// This instruction only succeeds if the transient stake account does not exist.
// The minimum amount to move is rent-exemption
...
#[derive(Accounts)]
pub struct IncreaseValidatorStakeWithVote<'info> {
...
impl<'info> IncreaseValidatorStakeWithVote<'info> {
