// IncreaseAdditionalValidatorStakeWithVote
...
#[derive(Accounts)]
pub struct IncreaseAdditionalValidatorStakeWithVote<'info> {
...
impl<'info> IncreaseAdditionalValidatorStakeWithVote<'info> {
