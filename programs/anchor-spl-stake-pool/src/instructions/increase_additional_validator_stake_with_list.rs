// IncreaseAdditionalValidatorStakeWithList
...
use {
    ...
    spl_stake_pool::instruction::increase_additional_validator_stake_with_list,
};

#[derive(Accounts)]
pub struct IncreaseAdditionalValidatorStakeWithList<'info> {
...
impl<'info> IncreaseAdditionalValidatorStakeWithList<'info> {
    ...
    pub fn context_handler(
        ...
        let ix = increase_additional_validator_stake_with_list(
